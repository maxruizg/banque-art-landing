...
const footerLinks = {
  servicios: [
    { name: "Catering para Bodas", href: "#servicios" },
    { name: "Eventos Corporativos", href: "#servicios" },
    { name: "Cenas Privadas", href: "#servicios" },
    { name: "Consultoría de Menú", href: "#servicios" },
  ],
  empresa: [
    { name: "Nosotros", href: "#nosotros" },
    { name: "Nuestra Galería", href: "#galeria" },
...
export function Footer() {
  return (
    <footer className="bg-charcoal-800 text-cream-100 py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-12">
            ...
            <div className="flex gap-4">
              {["Instagram", "Facebook", "Pinterest"].map((social) => (
                <motion.a
                  key={social}
                  href="#"
                  className="w-10 h-10 bg-charcoal-700 rounded-lg flex items-center justify-center text-cream-300 hover:bg-gold-500 hover:text-cream-50 transition-colors"
          ...
          {/* Servicios */}
          <div>
            <h4 className="font-medium text-cream-50 mb-4 uppercase tracking-wider text-sm">
              Servicios
            </h4>
        ...
        <div className="pt-8 border-t border-charcoal-700 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-cream-400 text-sm">
            &copy; {new Date().getFullYear()} Banque-Art. Todos los derechos reservados.
          </p>
          <p className="text-cream-400 text-sm">
            Creado con pasión en Ciudad de México
          </p>
        </div>
      </div>
    </footer>
