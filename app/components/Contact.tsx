        ...
        <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-charcoal-600">
                    <a href="tel:+525567070128" className="hover:text-tan-600 transition-colors">+52 55 6707 0128</a>
                  </p>
                  <p className="mt-1">
                    <a
                      href="https://wa.me/525567070128"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-green-600 hover:text-green-700 transition-colors text-sm inline-flex items-center gap-1"
                    >
          ...
          >
            ...
            <form className="space-y-6" onSubmit={(e) => {
              ...
              const nombre = (form.querySelector('#contact-nombre') as HTMLInputElement)?.value || '';
              const apellido = (form.querySelector('#contact-apellido') as HTMLInputElement)?.value || '';
              const email = (form.querySelector('#contact-email') as HTMLInputElement)?.value || '';
              const tipoEvento = (form.querySelector('#contact-tipo-evento') as HTMLSelectElement)?.selectedOptions[0]?.text || '';
              const invitados = (form.querySelector('#contact-invitados') as HTMLInputElement)?.value || '';
              const fecha = (form.querySelector('#contact-fecha') as HTMLInputElement)?.value || '';

              let text = `Hola, soy ${nombre} ${apellido}.`;
              if (tipoEvento && tipoEvento !== 'Selecciona el tipo de evento') text += `\nTipo de evento: ${tipoEvento}`;
              if (invitados) text += `\nInvitados: ${invitados}`;
              if (fecha) text += `\nFecha: ${fecha}`;
              if (email) text += `\nCorreo: ${email}`;
              if (mensaje) text += `\n\n${mensaje}`;

              window.open(`https://wa.me/525567070128?text=${encodeURIComponent(text)}`, '_blank');
            }}>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="contact-nombre" className="block text-charcoal-700 text-sm mb-2">
                    Nombre
                  </label>
                  <input
                    id="contact-nombre"
                ...
                <div>
                  <label htmlFor="contact-apellido" className="block text-charcoal-700 text-sm mb-2">
                    Apellido
                  </label>
                  <input
                    id="contact-apellido"
              ...
              <div>
                <label htmlFor="contact-email" className="block text-charcoal-700 text-sm mb-2">
                  Correo Electrónico
                </label>
                <input
                  id="contact-email"
              ...
              <div>
                <label htmlFor="contact-tipo-evento" className="block text-charcoal-700 text-sm mb-2">
                  Tipo de Evento
                </label>
                <select id="contact-tipo-evento" className="w-full px-4 py-3 bg-cream-50 border border-tan-200 rounded-xl focus:outline-none focus:border-tan-400 transition-colors text-charcoal-600">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="contact-invitados" className="block text-charcoal-700 text-sm mb-2">
                    Número de Invitados
                  </label>
                ...
                <div>
                  <label htmlFor="contact-fecha" className="block text-charcoal-700 text-sm mb-2">
                    Fecha del Evento
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <div>
                <label htmlFor="contact-mensaje" className="block text-charcoal-700 text-sm mb-2">
              ...
              <motion.button
                type="submit"
                className="w-full bg-green-600 text-cream-50 py-4 rounded-xl text-sm tracking-wide uppercase hover:bg-green-700 transition-colors inline-flex items-center justify-center gap-2"
